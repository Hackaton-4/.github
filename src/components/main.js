    ...
    <>
      <section className="main">
        <div className="main__block">
          <p className="main__paragraph">Olá Zezinho, onde vamos salvar alimentos hoje? </p>
          <label><input className="main__input_cep" placeholder='insira seu CEP'/><span className="" /></label>
          <h1 className="main__title">É a economia aliada à sustentabilidade!</h1>
